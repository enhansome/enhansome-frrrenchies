# Awesome :rooster: frrrenchies :rooster: with stars
...
* [rgeoapi](https://github.com/ColinFay/rgeoapi) ⭐ 11 | 🐛 2 | 🌐 R | 📅 2019-03-25 par @ColinFay : un client R pour l'[API Géo](https://api.gouv.fr/api/api-geo.html)
* [vacancesscolr](https://github.com/Tutuchan/vacancesscolr) ⭐ 10 | 🐛 1 | 🌐 R | 📅 2019-11-27 par @Tutuchan : les [données des vacances scolaires](https://www.data.gouv.fr/fr/datasets/vacances-scolaires-par-zones/) dans R
* [baacker](https://github.com/Bakaniko/baacker) ⭐ 4 | 🐛 1 | 🌐 R | 📅 2020-06-11 par @Bakaniko : un package pour accéder à la [base de données des accidents corporels de la circulation](https://www.data.gouv.fr/datasets/53698f4ca3a729239d2036df)
* [legislatives2017](https://github.com/ThinkR-open/legislatives2017) ⚠️ Archived par @ThinkR-open : les données des élections législatives dans un package R
* [lexiquer](https://github.com/ColinFay/lexiquer) ⭐ 4 | 🐛 0 | 🌐 R | 📅 2017-11-13 : Un wrapper autour de la base de données lexicale Lexique 3.81.
* [entreprises](https://github.com/pachevalier/entreprises) ⭐ 0 | 🐛 0 | 🌐 R | 📅 2020-03-10 par @pachevalier : accéder aux données des entreprises
...
* [r-init](http://r.slmc.fr/), [r-perf](http://t.slmc.fr/perf) et [r-dev](https://github.com/martinchevalier/r_dev) ⭐ 0 | 🐛 0 | 🌐 TeX | 📅 2018-06-26 support des formations R données à l'Insee par @martinchevalier
...
* [Le text-mining expliqué à ma grand mère](https://github.com/ColinFay/conf/blob/master/2017-11-breizh-data-club/fay_colin_tm_explique_grand_mere.pdf) ⭐ 48 | 🐛 1 | 🌐 R | 📅 2018-07-14 - @ColinFay, Meetup du Breizh Data Club
* [Les API, un enfeR ?](https://github.com/ColinFay/conf/blob/master/2017-06-Anglet/api_enfer_colin_fay_thinkr.pdf) ⭐ 48 | 🐛 1 | 🌐 R | 📅 2018-07-14 - @ColinFay, Rencontres R 2017
* [Les SIG et la cartographie avec R - Rencontres R (FR)](https://github.com/statnmap/prez/blob/master/2018-07-06_RR2018_Statnmap.pdf) ⭐ 21 | 🐛 0 | 📅 2024-01-25 - @statnmap, Rencontres R 2018, Rennes
...
## :speech\_balloon: Entraide et échanges :speech\_balloon:
...
### :busts\_in\_silhouette: Communautaires :busts\_in\_silhouette:
...
* [@talk\_rstatsfr](https://twitter.com/talk_rstatsfr) : Un bot twitter retweetant tous les tweets contenant le hashtag #RStatsFR
